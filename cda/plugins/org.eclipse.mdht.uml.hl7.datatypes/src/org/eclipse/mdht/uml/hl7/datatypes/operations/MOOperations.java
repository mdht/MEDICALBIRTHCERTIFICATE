 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.MO#validateMO(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate MO</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.MO#setValue(java.lang.Double) <em>Set Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MOOperations extends ANYOperations {
	...
	public static boolean validateMO(MO mo, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		synchronized (EOCL_ENV) {
			...
			try {
				VALIDATE_MO__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_MO__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
