 ...
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getStates <em>State</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getCounties <em>County</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getCities <em>City</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getPostalCodes <em>Postal Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getStreetAddressLines <em>Street Address Line</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getHouseNumbers <em>House Number</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getHouseNumberNumerics <em>House Number Numeric</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getDirections <em>Direction</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getStreetNames <em>Street Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getStreetNameBases <em>Street Name Base</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getStreetNameTypes <em>Street Name Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getAdditionalLocators <em>Additional Locator</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getUnitIDs <em>Unit ID</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getUnitTypes <em>Unit Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getCareOfs <em>Care Of</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getCensusTracts <em>Census Tract</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getDeliveryAddressLines <em>Delivery Address Line</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getDeliveryInstallationTypes <em>Delivery Installation Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getDeliveryInstallationAreas <em>Delivery Installation Area</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getDeliveryInstallationQualifiers <em>Delivery Installation Qualifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getDeliveryModes <em>Delivery Mode</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getDeliveryModeIdentifiers <em>Delivery Mode Identifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getBuildingNumberSuffixes <em>Building Number Suffix</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getPostBoxes <em>Post Box</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getPrecincts <em>Precinct</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getParts <em>Part</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ADImpl#getUseablePeriods <em>Useable Period</em>}</li>
