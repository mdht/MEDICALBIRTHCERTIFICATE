 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.CS#validateOriginalText(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Original Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.CS#validateCodeSystem(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Code System</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.CS#validateCodeSystemName(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Code System Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.CS#validateCodeSystemVersion(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Code System Version</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.CS#validateDisplayName(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Display Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CSOperations extends CVOperations {
	...
	public static boolean validateCodeSystemVersion(CS cs, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		synchronized (EOCL_ENV) {
			...
			helper.setContext(DatatypesPackage.Literals.CS);
			try {
				VALIDATE_CODE_SYSTEM_VERSION__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_CODE_SYSTEM_VERSION__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
	...
	public static boolean validateDisplayName(CS cs, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		synchronized (EOCL_ENV) {
			...
			helper.setContext(DatatypesPackage.Literals.CS);
			try {
				VALIDATE_DISPLAY_NAME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_DISPLAY_NAME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
