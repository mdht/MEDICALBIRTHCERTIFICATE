 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#validateDelimiter(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Delimiter</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#validateFamily(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Family</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#validateGiven(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Given</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#validatePrefix(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Prefix</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#validateSuffix(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Suffix</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#addDelimiter(java.lang.String) <em>Add Delimiter</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#addFamily(java.lang.String) <em>Add Family</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#addGiven(java.lang.String) <em>Add Given</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#addPrefix(java.lang.String) <em>Add Prefix</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#addSuffix(java.lang.String) <em>Add Suffix</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#addText(java.lang.String) <em>Add Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#getText() <em>Get Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EN#getText(boolean) <em>Get Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ENOperations extends ANYOperations {
	...
	public static boolean validateFamily(EN en, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		synchronized (EOCL_ENV) {
			...
			helper.setContext(DatatypesPackage.Literals.EN);
			try {
				VALIDATE_FAMILY__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_FAMILY__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
	...
	public static boolean validateGiven(EN en, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		synchronized (EOCL_ENV) {
			...
			helper.setContext(DatatypesPackage.Literals.EN);
			try {
				VALIDATE_GIVEN__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_GIVEN__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
	...
	public static boolean validatePrefix(EN en, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		synchronized (EOCL_ENV) {
			...
			helper.setContext(DatatypesPackage.Literals.EN);
			try {
				VALIDATE_PREFIX__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_PREFIX__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
	...
	public static boolean validateSuffix(EN en, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		synchronized (EOCL_ENV) {
			...
			helper.setContext(DatatypesPackage.Literals.EN);
			try {
				VALIDATE_SUFFIX__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_SUFFIX__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
