 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getOriginalText <em>Original Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getQualifiers <em>Qualifier</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getTranslations <em>Translation</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getCodeSystem <em>Code System</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getCodeSystemName <em>Code System Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getCodeSystemVersion <em>Code System Version</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getDisplayName <em>Display Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getSDTCValueSet <em>SDTC Value Set</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.CDImpl#getSDTCValueSetVersion <em>SDTC Value Set Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CDImpl extends ANYImpl implements CD {
	...
	public void setSDTCValueSet(String newSDTCValueSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.CD__SDTC_VALUE_SET, oldSDTCValueSet, sDTCValueSet));
	}
	...
	public void setSDTCValueSetVersion(String newSDTCValueSetVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.CD__SDTC_VALUE_SET_VERSION, oldSDTCValueSetVersion, sDTCValueSetVersion));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case DatatypesPackage.CD__SDTC_VALUE_SET:
				return SDTC_VALUE_SET_EDEFAULT == null ? sDTCValueSet != null : !SDTC_VALUE_SET_EDEFAULT.equals(sDTCValueSet);
			case DatatypesPackage.CD__SDTC_VALUE_SET_VERSION:
				return SDTC_VALUE_SET_VERSION_EDEFAULT == null ? sDTCValueSetVersion != null : !SDTC_VALUE_SET_VERSION_EDEFAULT.equals(sDTCValueSetVersion);
		}
