 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.CR#validateCR(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate CR</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CROperations extends ANYOperations {
	...
	public static boolean validateCR(CR cr, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		synchronized (EOCL_ENV) {
			...
			try {
				VALIDATE_CR__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_CR__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
