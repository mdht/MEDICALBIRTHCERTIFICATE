 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EIVL_event#validateOriginalText(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Original Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EIVL_event#validateTranslation(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Translation</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EIVL_event#validateCodeSystem(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Code System</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EIVL_event#validateCodeSystemName(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Code System Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EIVL_event#validateCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.EIVL_event#init() <em>Init</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EIVL_eventOperations extends CEOperations {
	...
	public static boolean validateOriginalText(EIVL_event eivL_event, DiagnosticChain diagnostics,
		...
		synchronized (EOCL_ENV) {
			...
			try {
				VALIDATE_ORIGINAL_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_ORIGINAL_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_ORIGINAL_TEXT__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(eivL_event)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	...
	public static boolean validateCodeSystem(EIVL_event eivL_event, DiagnosticChain diagnostics,
		...
		synchronized (EOCL_ENV) {
			...
			helper.setContext(DatatypesPackage.Literals.EIVL_EVENT);
			try {
				VALIDATE_CODE_SYSTEM__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_CODE_SYSTEM__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
	...
	public static boolean validateCodeSystemName(EIVL_event eivL_event, DiagnosticChain diagnostics,
		...
		synchronized (EOCL_ENV) {
			...
			helper.setContext(DatatypesPackage.Literals.EIVL_EVENT);
			try {
				VALIDATE_CODE_SYSTEM_NAME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_CODE_SYSTEM_NAME__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
			catch (ParserException pe) {
				throw new UnsupportedOperationException(pe.getLocalizedMessage());
			}
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_CODE_SYSTEM_NAME__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(eivL_event)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	 ...
	 * @generated NOT
	 */
	public static boolean validateCode(EIVL_event eivL_event, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
