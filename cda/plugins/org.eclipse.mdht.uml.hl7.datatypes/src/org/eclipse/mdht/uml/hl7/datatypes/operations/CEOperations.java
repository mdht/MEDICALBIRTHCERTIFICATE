 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.CE#validateQualifier(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Qualifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CEOperations extends ANYOperations {
	...
	public static boolean validateQualifier(CE ce, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		synchronized (EOCL_ENV) {
			...
			try {
				VALIDATE_QUALIFIER__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.set(helper.createInvariant(VALIDATE_QUALIFIER__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP));
			}
