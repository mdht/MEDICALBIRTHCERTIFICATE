 ...
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.EDImpl#getThumbnail <em>Thumbnail</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.EDImpl#getMediaType <em>Media Type</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.EDImpl#getLanguage <em>Language</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.EDImpl#getCompression <em>Compression</em>}</li>
...
public class EDImpl extends BINImpl implements ED {
	...
	public void setMediaType(String newMediaType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.ED__MEDIA_TYPE, oldMediaType, mediaType, !oldMediaTypeESet));
	}
	...
	public void unsetMediaType() {
		...
		mediaTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DatatypesPackage.ED__MEDIA_TYPE, oldMediaType, MEDIA_TYPE_EDEFAULT, oldMediaTypeESet));
	}
	...
	public String getCDATA() {
		return EDOperations.getCDATA(this);
	}
