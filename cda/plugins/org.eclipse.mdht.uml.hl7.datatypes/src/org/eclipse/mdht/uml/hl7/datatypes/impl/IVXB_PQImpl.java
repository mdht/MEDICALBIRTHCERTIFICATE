...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IVXB PQ</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class IVXB_PQImpl extends PQImpl implements IVXB_PQ {
	/**
	...
	protected EClass eStaticClass() {
		return DatatypesPackage.Literals.IVXB_PQ;
	}
	...
	public void setInclusive(Boolean newInclusive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.IVXB_PQ__INCLUSIVE, oldInclusive, inclusive));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatatypesPackage.IVXB_PQ__INCLUSIVE:
				return getInclusive();
		}
