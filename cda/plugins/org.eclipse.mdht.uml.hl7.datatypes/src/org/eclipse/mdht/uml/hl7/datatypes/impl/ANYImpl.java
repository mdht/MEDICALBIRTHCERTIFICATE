 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.hl7.datatypes.impl.ANYImpl#getNullFlavor <em>Null Flavor</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ANYImpl extends EObjectImpl implements ANY {
	...
	protected EClass eStaticClass() {
		return DatatypesPackage.Literals.ANY;
	}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatatypesPackage.ANY__NULL_FLAVOR, oldNullFlavor, nullFlavor, !oldNullFlavorESet));
	}
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DatatypesPackage.ANY__NULL_FLAVOR, oldNullFlavor, NULL_FLAVOR_EDEFAULT, oldNullFlavorESet));
	}
	 ...
	 * @generated
	 */
	public boolean matches(String featureName, String regularExpression) {
		return ANYOperations.matches(this, featureName, regularExpression);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatatypesPackage.ANY__NULL_FLAVOR:
