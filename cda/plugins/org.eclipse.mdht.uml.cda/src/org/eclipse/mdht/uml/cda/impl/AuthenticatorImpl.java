...
import org.eclipse.mdht.uml.cda.operations.AuthenticatorOperations;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AuthenticatorImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AuthenticatorImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AuthenticatorImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AuthenticatorImpl#getTime <em>Time</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AuthenticatorImpl#getSignatureCode <em>Signature Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AuthenticatorImpl#getAssignedEntity <em>Assigned Entity</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AuthenticatorImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AuthenticatorImpl#getTypeCode <em>Type Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AuthenticatorImpl#getSDTCSignatureText <em>SDTC Signature Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuthenticatorImpl extends ParticipationImpl implements Authenticator {
	...
	public NotificationChain basicSetSDTCSignatureText(ED newSDTCSignatureText, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CDAPackage.AUTHENTICATOR__SDTC_SIGNATURE_TEXT, oldSDTCSignatureText, newSDTCSignatureText);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSDTCSignatureText(ED newSDTCSignatureText) {
		if (newSDTCSignatureText != sDTCSignatureText) {
			...
			if (sDTCSignatureText != null)
				msgs = ((InternalEObject)sDTCSignatureText).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CDAPackage.AUTHENTICATOR__SDTC_SIGNATURE_TEXT, null, msgs);
			if (newSDTCSignatureText != null)
				msgs = ((InternalEObject)newSDTCSignatureText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CDAPackage.AUTHENTICATOR__SDTC_SIGNATURE_TEXT, null, msgs);
			msgs = basicSetSDTCSignatureText(newSDTCSignatureText, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.AUTHENTICATOR__SDTC_SIGNATURE_TEXT, newSDTCSignatureText, newSDTCSignatureText));
	}
