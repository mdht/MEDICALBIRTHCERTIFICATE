...
import org.eclipse.mdht.uml.cda.operations.OrganizationOperations;
 ...
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.OrganizationImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.OrganizationImpl#getIds <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.OrganizationImpl#getNames <em>Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.OrganizationImpl#getTelecoms <em>Telecom</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.OrganizationImpl#getAddrs <em>Addr</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.OrganizationImpl#getStandardIndustryClassCode <em>Standard Industry Class Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.OrganizationImpl#getAsOrganizationPartOf <em>As Organization Part Of</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.OrganizationImpl#getNullFlavor <em>Null Flavor</em>}</li>
...
public class OrganizationImpl extends EntityImpl implements Organization {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAsOrganizationPartOf(OrganizationPartOf newAsOrganizationPartOf,
			NotificationChain msgs) {
	...
	public boolean validateClassCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return OrganizationOperations.validateClassCode(this, diagnostics, context);
	}
	...
	public boolean validateDeterminerCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return OrganizationOperations.validateDeterminerCode(this, diagnostics, context);
	}
