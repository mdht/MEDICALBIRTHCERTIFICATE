 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.LabeledDrug#validateClassCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Class Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.LabeledDrug#validateDeterminerCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Determiner Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabeledDrugOperations extends EntityOperations {
	 ...
	 * @generated
	 */
	public static boolean validateClassCode(LabeledDrug labeledDrug, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"LabeledDrugClassCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(labeledDrug)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	 ...
	 * @generated
	 */
	public static boolean validateDeterminerCode(LabeledDrug labeledDrug, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"LabeledDrugDeterminerCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DETERMINER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(labeledDrug)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
