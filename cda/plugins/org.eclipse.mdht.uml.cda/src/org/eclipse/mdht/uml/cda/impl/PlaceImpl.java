...
import org.eclipse.mdht.uml.cda.operations.PlaceOperations;
...
import org.eclipse.mdht.uml.hl7.vocab.EntityClassPlace;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.PlaceImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.PlaceImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.PlaceImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.PlaceImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.PlaceImpl#getAddr <em>Addr</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.PlaceImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.PlaceImpl#getClassCode <em>Class Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.PlaceImpl#getDeterminerCode <em>Determiner Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceImpl extends EntityImpl implements Place {
	/**
	...
	public boolean validateClassCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return PlaceOperations.validateClassCode(this, diagnostics, context);
	}
	...
	public boolean validateDeterminerCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return PlaceOperations.validateDeterminerCode(this, diagnostics, context);
	}
	...
	public EList<EN> getNames() {
		return PlaceOperations.getNames(this);
	}
	...
	public EList<AD> getAddrs() {
		return PlaceOperations.getAddrs(this);
	}
