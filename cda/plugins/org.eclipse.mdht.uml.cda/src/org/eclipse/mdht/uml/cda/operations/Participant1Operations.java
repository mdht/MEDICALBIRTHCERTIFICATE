 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.Participant1#validateContextControlCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Context Control Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Participant1Operations extends ParticipationOperations {
	 ...
	 * @generated
	 */
	public static boolean validateContextControlCode(Participant1 participant1, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"Participant1ContextControlCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_CONTEXT_CONTROL_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(participant1)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
