 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.SubjectPerson#validateClassCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Class Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.SubjectPerson#validateDeterminerCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Determiner Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubjectPersonOperations extends EntityOperations {
	 ...
	 * @generated
	 */
	public static boolean validateClassCode(SubjectPerson subjectPerson, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"SubjectPersonClassCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(subjectPerson)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	 ...
	 * @generated
	 */
	public static boolean validateDeterminerCode(SubjectPerson subjectPerson, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"SubjectPersonDeterminerCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DETERMINER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(subjectPerson)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
