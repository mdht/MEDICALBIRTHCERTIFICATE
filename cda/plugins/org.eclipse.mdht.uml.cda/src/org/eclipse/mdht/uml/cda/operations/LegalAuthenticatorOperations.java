 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.LegalAuthenticator#validateTypeCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Type Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.LegalAuthenticator#validateContextControlCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Context Control Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LegalAuthenticatorOperations extends ParticipationOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.isTypeCodeDefined() implies self.typeCode=vocab::ParticipationType::LA";
	 ...
	 * @generated
	 */
	public static boolean validateTypeCode(LegalAuthenticator legalAuthenticator, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"LegalAuthenticatorTypeCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(legalAuthenticator)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
    ...
    DatatypesUtil.increment(context,"LegalAuthenticatorContextControlCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_CONTEXT_CONTROL_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(legalAuthenticator)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
