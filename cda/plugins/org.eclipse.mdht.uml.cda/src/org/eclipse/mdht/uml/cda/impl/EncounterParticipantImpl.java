 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterParticipantImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterParticipantImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterParticipantImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterParticipantImpl#getTime <em>Time</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterParticipantImpl#getAssignedEntity <em>Assigned Entity</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterParticipantImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterParticipantImpl#getTypeCode <em>Type Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EncounterParticipantImpl extends ParticipationImpl implements EncounterParticipant {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		nullFlavorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.ENCOUNTER_PARTICIPANT__NULL_FLAVOR, oldNullFlavor, nullFlavor, !oldNullFlavorESet));
	}
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.ENCOUNTER_PARTICIPANT__NULL_FLAVOR, oldNullFlavor, NULL_FLAVOR_EDEFAULT, oldNullFlavorESet));
	}
	...
	public void setTypeCode(x_EncounterParticipant newTypeCode) {
		...
		typeCodeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.ENCOUNTER_PARTICIPANT__TYPE_CODE, oldTypeCode, typeCode, !oldTypeCodeESet));
	}
	...
	public void unsetTypeCode() {
		...
		typeCodeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.ENCOUNTER_PARTICIPANT__TYPE_CODE, oldTypeCode, TYPE_CODE_EDEFAULT, oldTypeCodeESet));
	}
