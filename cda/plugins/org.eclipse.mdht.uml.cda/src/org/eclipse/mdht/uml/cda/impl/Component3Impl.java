...
import org.eclipse.mdht.uml.cda.operations.Component3Operations;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component3Impl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component3Impl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component3Impl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component3Impl#getSection <em>Section</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component3Impl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component3Impl#getTypeCode <em>Type Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component3Impl#getContextConductionInd <em>Context Conduction Ind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Component3Impl extends ActRelationshipImpl implements Component3 {
	/**
	...
	protected EClass eStaticClass() {
		return CDAPackage.Literals.COMPONENT3;
	}
	...
	public void setContextConductionInd(Boolean newContextConductionInd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT3__CONTEXT_CONDUCTION_IND, oldContextConductionInd, contextConductionInd, !oldContextConductionIndESet));
	}
	...
	public void unsetContextConductionInd() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.COMPONENT3__CONTEXT_CONDUCTION_IND, oldContextConductionInd, CONTEXT_CONDUCTION_IND_EDEFAULT, oldContextConductionIndESet));
	}
	...
	public boolean validateTypeCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return Component3Operations.validateTypeCode(this, diagnostics, context);
	}
	...
	public boolean validateContextConductionInd(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return Component3Operations.validateContextConductionInd(this, diagnostics, context);
	}
