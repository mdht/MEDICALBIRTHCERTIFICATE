...
import org.eclipse.mdht.uml.cda.operations.Component4Operations;
...
import org.eclipse.mdht.uml.hl7.vocab.ActRelationshipHasComponent;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getRealmCodes <em>Realm Code</em>}</li>
 ...
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getObservation <em>Observation</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getObservationMedia <em>Observation Media</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getOrganizer <em>Organizer</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getProcedure <em>Procedure</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getRegionOfInterest <em>Region Of Interest</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getSubstanceAdministration <em>Substance Administration</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getSupply <em>Supply</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getTypeCode <em>Type Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.Component4Impl#getContextConductionInd <em>Context Conduction Ind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Component4Impl extends ActRelationshipImpl implements Component4 {
	/**
	...
	public NotificationChain basicSetPriorityNumber(INT newPriorityNumber, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT4__PRIORITY_NUMBER, oldPriorityNumber, newPriorityNumber);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPriorityNumber(INT newPriorityNumber) {
		if (newPriorityNumber != priorityNumber) {
			...
			if (priorityNumber != null)
				msgs = ((InternalEObject)priorityNumber).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__PRIORITY_NUMBER, null, msgs);
			if (newPriorityNumber != null)
				msgs = ((InternalEObject)newPriorityNumber).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CDAPackage.COMPONENT4__PRIORITY_NUMBER, null, msgs);
			msgs = basicSetPriorityNumber(newPriorityNumber, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT4__PRIORITY_NUMBER, newPriorityNumber, newPriorityNumber));
	}
	...
	public void setContextConductionInd(Boolean newContextConductionInd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.COMPONENT4__CONTEXT_CONDUCTION_IND, oldContextConductionInd, contextConductionInd, !oldContextConductionIndESet));
	}
	...
	public void unsetContextConductionInd() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.COMPONENT4__CONTEXT_CONDUCTION_IND, oldContextConductionInd, CONTEXT_CONDUCTION_IND_EDEFAULT, oldContextConductionIndESet));
	}
