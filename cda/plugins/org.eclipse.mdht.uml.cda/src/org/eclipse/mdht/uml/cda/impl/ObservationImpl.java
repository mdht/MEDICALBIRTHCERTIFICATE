 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getIds <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getDerivationExpr <em>Derivation Expr</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getStatusCode <em>Status Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getEffectiveTime <em>Effective Time</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getPriorityCode <em>Priority Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getRepeatNumber <em>Repeat Number</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getLanguageCode <em>Language Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getValues <em>Value</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getInterpretationCodes <em>Interpretation Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getMethodCodes <em>Method Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getTargetSiteCodes <em>Target Site Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getSpecimens <em>Specimen</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getInformants <em>Informant</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getParticipants <em>Participant</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getEntryRelationships <em>Entry Relationship</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getReferences <em>Reference</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getPreconditions <em>Precondition</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getReferenceRanges <em>Reference Range</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ObservationImpl#getNullFlavor <em>Null Flavor</em>}</li>
 ...
 * @generated
 */
public class ObservationImpl extends ClinicalStatementImpl implements Observation {
	/**
	...
	public EList<InFulfillmentOf1> getInFulfillmentOf1s() {
		if (inFulfillmentOf1s == null) {
			inFulfillmentOf1s = new EObjectContainmentEList<InFulfillmentOf1>(InFulfillmentOf1.class, this, CDAPackage.OBSERVATION__IN_FULFILLMENT_OF1);
		}
