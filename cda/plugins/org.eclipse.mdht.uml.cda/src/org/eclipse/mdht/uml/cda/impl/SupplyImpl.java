...
import org.eclipse.mdht.uml.hl7.vocab.ActClassSupply;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getIds <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getStatusCode <em>Status Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getEffectiveTimes <em>Effective Time</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getPriorityCodes <em>Priority Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getRepeatNumber <em>Repeat Number</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getIndependentInd <em>Independent Ind</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getQuantity <em>Quantity</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getExpectedUseTime <em>Expected Use Time</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getSpecimens <em>Specimen</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getProduct <em>Product</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getInformants <em>Informant</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SupplyImpl#getParticipants <em>Participant</em>}</li>
...
public class SupplyImpl extends ClinicalStatementImpl implements Supply {
	...
	public EList<InFulfillmentOf1> getInFulfillmentOf1s() {
		if (inFulfillmentOf1s == null) {
			inFulfillmentOf1s = new EObjectContainmentEList<InFulfillmentOf1>(InFulfillmentOf1.class, this, CDAPackage.SUPPLY__IN_FULFILLMENT_OF1);
		}
