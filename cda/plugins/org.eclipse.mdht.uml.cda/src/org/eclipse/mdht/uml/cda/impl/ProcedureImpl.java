 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getIds <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getStatusCode <em>Status Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getEffectiveTime <em>Effective Time</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getPriorityCode <em>Priority Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getLanguageCode <em>Language Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getMethodCodes <em>Method Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getApproachSiteCodes <em>Approach Site Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getTargetSiteCodes <em>Target Site Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getSpecimens <em>Specimen</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getInformants <em>Informant</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getParticipants <em>Participant</em>}</li>
 ...
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ProcedureImpl#getNegationInd <em>Negation Ind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcedureImpl extends ClinicalStatementImpl implements Procedure {
	/**
	...
	public EList<InFulfillmentOf1> getInFulfillmentOf1s() {
		if (inFulfillmentOf1s == null) {
			inFulfillmentOf1s = new EObjectContainmentEList<InFulfillmentOf1>(InFulfillmentOf1.class, this, CDAPackage.PROCEDURE__IN_FULFILLMENT_OF1);
		}
