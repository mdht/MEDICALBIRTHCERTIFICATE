 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.OrganizationPartOf#validateClassCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Class Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrganizationPartOfOperations extends RoleOperations {
	 ...
	 * @generated
	 */
	public static boolean validateClassCode(OrganizationPartOf organizationPartOf, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"OrganizationPartOfClassCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(organizationPartOf)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
