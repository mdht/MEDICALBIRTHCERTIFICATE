 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#addAct(org.eclipse.mdht.uml.cda.Act) <em>Add Act</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#addEncounter(org.eclipse.mdht.uml.cda.Encounter) <em>Add Encounter</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#addObservation(org.eclipse.mdht.uml.cda.Observation) <em>Add Observation</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#addObservationMedia(org.eclipse.mdht.uml.cda.ObservationMedia) <em>Add Observation Media</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#addOrganizer(org.eclipse.mdht.uml.cda.Organizer) <em>Add Organizer</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#addProcedure(org.eclipse.mdht.uml.cda.Procedure) <em>Add Procedure</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#addRegionOfInterest(org.eclipse.mdht.uml.cda.RegionOfInterest) <em>Add Region Of Interest</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#addSubstanceAdministration(org.eclipse.mdht.uml.cda.SubstanceAdministration) <em>Add Substance Administration</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#addSupply(org.eclipse.mdht.uml.cda.Supply) <em>Add Supply</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getActs() <em>Get Acts</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getClinicalDocument() <em>Get Clinical Document</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getEncounters() <em>Get Encounters</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getEntryRelationshipTargets(org.eclipse.mdht.uml.hl7.vocab.x_ActRelationshipEntryRelationship, java.lang.Object) <em>Get Entry Relationship Targets</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getEntryRelationshipTargets(java.lang.Object) <em>Get Entry Relationship Targets</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getObservations() <em>Get Observations</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getObservationMedia() <em>Get Observation Media</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getOrganizers() <em>Get Organizers</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getProcedures() <em>Get Procedures</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getRegionsOfInterest() <em>Get Regions Of Interest</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getSection() <em>Get Section</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getSubstanceAdministrations() <em>Get Substance Administrations</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getSupplies() <em>Get Supplies</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasActTemplate(java.lang.String) <em>Has Act Template</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasCode(java.lang.String, java.lang.String, java.lang.String) <em>Has Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasEncounterTemplate(java.lang.String) <em>Has Encounter Template</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasObservationMediaTemplate(java.lang.String) <em>Has Observation Media Template</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasObservationTemplate(java.lang.String) <em>Has Observation Template</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasOrganizerTemplate(java.lang.String) <em>Has Organizer Template</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasProcedureTemplate(java.lang.String) <em>Has Procedure Template</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasRegionOfInterestTemplate(java.lang.String) <em>Has Region Of Interest Template</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasSubstanceAdministrationTemplate(java.lang.String) <em>Has Substance Administration Template</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasSupplyTemplate(java.lang.String) <em>Has Supply Template</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#hasTemplateId(java.lang.String) <em>Has Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getParticipantRoles() <em>Get Participant Roles</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.ClinicalStatement#getAssignedEntities() <em>Get Assigned Entities</em>}</li>
 * </ul>
 *
 * @generated
 */
