...
import org.eclipse.mdht.uml.hl7.rim.impl.RoleImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getIds <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getAddrs <em>Addr</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getTelecoms <em>Telecom</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getAssociatedPerson <em>Associated Person</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getScopingOrganization <em>Scoping Organization</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getSDTCPatient <em>SDTC Patient</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getClassCode <em>Class Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.AssociatedEntityImpl#getIdentityDocs <em>Identity Doc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssociatedEntityImpl extends RoleImpl implements AssociatedEntity {
	...
	/**
	 * The cached value of the '{@link #getIdentityDocs() <em>Identity Doc</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIdentityDocs()
	 * @generated
	 * @ordered
	 */
	protected EList<IdentityDoc> identityDocs;
	 ...
	 * @generated
	 */
	public EList<IdentityDoc> getIdentityDocs() {
		if (identityDocs == null) {
			identityDocs = new EObjectContainmentEList<IdentityDoc>(IdentityDoc.class, this, CDAPackage.ASSOCIATED_ENTITY__IDENTITY_DOC);
		}
		return identityDocs;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case CDAPackage.ASSOCIATED_ENTITY__IDENTITY_DOC:
				return ((InternalEList<?>)getIdentityDocs()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CDAPackage.ASSOCIATED_ENTITY__CLASS_CODE:
				...
				return;
			case CDAPackage.ASSOCIATED_ENTITY__IDENTITY_DOC:
				getIdentityDocs().clear();
				getIdentityDocs().addAll((Collection<? extends IdentityDoc>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CDAPackage.ASSOCIATED_ENTITY__IDENTITY_DOC:
				return identityDocs != null && !identityDocs.isEmpty();
		}
