 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getSequenceNumber <em>Sequence Number</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getSeperatableInd <em>Seperatable Ind</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getAct <em>Act</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getEncounter <em>Encounter</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getObservation <em>Observation</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getObservationMedia <em>Observation Media</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getOrganizer <em>Organizer</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getProcedure <em>Procedure</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getRegionOfInterest <em>Region Of Interest</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getSubstanceAdministration <em>Substance Administration</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getSupply <em>Supply</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getTypeCode <em>Type Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getInversionInd <em>Inversion Ind</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getContextConductionInd <em>Context Conduction Ind</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EntryRelationshipImpl#getNegationInd <em>Negation Ind</em>}</li>
 * </ul>
 *
 * @generated
 */
