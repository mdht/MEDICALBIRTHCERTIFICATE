 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.StructuredBody#validateClassCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Class Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.StructuredBody#validateMoodCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mood Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructuredBodyOperations extends ActOperations {
	 ...
	 * @generated
	 */
	public static boolean validateClassCode(StructuredBody structuredBody, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"StructuredBodyClassCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(structuredBody)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
	 ...
	 * @generated
	 */
	public static boolean validateMoodCode(StructuredBody structuredBody, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
    ...
    DatatypesUtil.increment(context,"StructuredBodyMoodCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(structuredBody)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
