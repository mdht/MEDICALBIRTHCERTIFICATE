 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.Entity#validateDeterminerCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Determiner Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityOperations extends org.eclipse.mdht.uml.hl7.rim.operations.EntityOperations {
	/**
	 ...
	 * @generated
	 */
	public static boolean validateDeterminerCode(Entity entity, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"EntityDeterminerCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_DETERMINER_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(entity)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
