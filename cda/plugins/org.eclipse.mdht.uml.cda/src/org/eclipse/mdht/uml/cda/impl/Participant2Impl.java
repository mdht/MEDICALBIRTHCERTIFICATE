...
public class Participant2Impl extends ParticipationImpl implements Participant2 {
	...
	public NotificationChain basicSetSDTCFunctionCode(CE newSDTCFunctionCode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CDAPackage.PARTICIPANT2__SDTC_FUNCTION_CODE, oldSDTCFunctionCode, newSDTCFunctionCode);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSDTCFunctionCode(CE newSDTCFunctionCode) {
		if (newSDTCFunctionCode != sDTCFunctionCode) {
			...
			if (sDTCFunctionCode != null)
				msgs = ((InternalEObject)sDTCFunctionCode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CDAPackage.PARTICIPANT2__SDTC_FUNCTION_CODE, null, msgs);
			if (newSDTCFunctionCode != null)
				msgs = ((InternalEObject)newSDTCFunctionCode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CDAPackage.PARTICIPANT2__SDTC_FUNCTION_CODE, null, msgs);
			msgs = basicSetSDTCFunctionCode(newSDTCFunctionCode, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.PARTICIPANT2__SDTC_FUNCTION_CODE, newSDTCFunctionCode, newSDTCFunctionCode));
	}
