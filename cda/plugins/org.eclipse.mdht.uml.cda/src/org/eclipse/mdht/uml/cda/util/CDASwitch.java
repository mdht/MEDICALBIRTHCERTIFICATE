...
public class CDASwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CDAPackage.IDENTITY_DOC: {
				IdentityDoc identityDoc = (IdentityDoc)theEObject;
				T result = caseIdentityDoc(identityDoc);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case CDAPackage.IN_FULFILLMENT_OF1: {
				...
				if (result == null) result = caseActRelationship(inFulfillmentOf1);
				if (result == null) result = caseInfrastructureRoot(inFulfillmentOf1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Identity Doc</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Identity Doc</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIdentityDoc(IdentityDoc object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRIM_Act(org.eclipse.mdht.uml.hl7.rim.Act object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRIM_Entity(org.eclipse.mdht.uml.hl7.rim.Entity object) {
		return null;
	}
