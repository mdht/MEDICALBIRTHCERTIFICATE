 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterImpl#getIds <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterImpl#getCode <em>Code</em>}</li>
 ...
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterImpl#getInformants <em>Informant</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.EncounterImpl#getParticipants <em>Participant</em>}</li>
 ...
 * @generated
 */
public class EncounterImpl extends ClinicalStatementImpl implements Encounter {
	/**
	...
	public EList<CE> getSDTCDischargeDispositionCodes() {
		if (sDTCDischargeDispositionCodes == null) {
			sDTCDischargeDispositionCodes = new EObjectContainmentEList<CE>(CE.class, this, CDAPackage.ENCOUNTER__SDTC_DISCHARGE_DISPOSITION_CODE);
		}
	...
	public EList<InFulfillmentOf1> getInFulfillmentOf1s() {
		if (inFulfillmentOf1s == null) {
			inFulfillmentOf1s = new EObjectContainmentEList<InFulfillmentOf1>(InFulfillmentOf1.class, this, CDAPackage.ENCOUNTER__IN_FULFILLMENT_OF1);
		}
