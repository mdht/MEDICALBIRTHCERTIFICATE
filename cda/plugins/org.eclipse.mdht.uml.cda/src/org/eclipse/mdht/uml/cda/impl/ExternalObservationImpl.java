...
import org.eclipse.mdht.uml.cda.operations.ExternalObservationOperations;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ExternalObservationImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ExternalObservationImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ExternalObservationImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ExternalObservationImpl#getIds <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ExternalObservationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ExternalObservationImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ExternalObservationImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ExternalObservationImpl#getClassCode <em>Class Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.ExternalObservationImpl#getMoodCode <em>Mood Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalObservationImpl extends ActImpl implements ExternalObservation {
	/**
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		nullFlavorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.EXTERNAL_OBSERVATION__NULL_FLAVOR, oldNullFlavor, nullFlavor, !oldNullFlavorESet));
	}
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.EXTERNAL_OBSERVATION__NULL_FLAVOR, oldNullFlavor, NULL_FLAVOR_EDEFAULT, oldNullFlavorESet));
	}
	...
	public void setClassCode(ActClassObservation newClassCode) {
		...
		classCodeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.EXTERNAL_OBSERVATION__CLASS_CODE, oldClassCode, classCode, !oldClassCodeESet));
	}
	...
	public void unsetClassCode() {
		...
		classCodeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.EXTERNAL_OBSERVATION__CLASS_CODE, oldClassCode, CLASS_CODE_EDEFAULT, oldClassCodeESet));
	}
	...
	public void setMoodCode(ActMood newMoodCode) {
		...
		moodCodeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.EXTERNAL_OBSERVATION__MOOD_CODE, oldMoodCode, moodCode, !oldMoodCodeESet));
	}
	...
	public void unsetMoodCode() {
		...
		moodCodeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.EXTERNAL_OBSERVATION__MOOD_CODE, oldMoodCode, MOOD_CODE_EDEFAULT, oldMoodCodeESet));
	}
	...
	public boolean validateMoodCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return ExternalObservationOperations.validateMoodCode(this, diagnostics, context);
	}
