...
import org.eclipse.mdht.uml.cda.operations.CustodianOrganizationOperations;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getIds <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getTelecom <em>Telecom</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getAddr <em>Addr</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getClassCode <em>Class Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.CustodianOrganizationImpl#getDeterminerCode <em>Determiner Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustodianOrganizationImpl extends EntityImpl implements CustodianOrganization {
	...
	public boolean validateClassCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return CustodianOrganizationOperations.validateClassCode(this, diagnostics, context);
	}
	...
	public boolean validateDeterminerCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return CustodianOrganizationOperations.validateDeterminerCode(this, diagnostics, context);
	}
	 ...
	 * @generated
	 */
	public EList<EN> getNames() {
		return CustodianOrganizationOperations.getNames(this);
	}
	...
	public EList<TEL> getTelecoms() {
		return CustodianOrganizationOperations.getTelecoms(this);
	}
	...
	public EList<AD> getAddrs() {
		return CustodianOrganizationOperations.getAddrs(this);
	}
