 ...
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getConfidentialityCode <em>Confidentiality Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getLanguageCode <em>Language Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getInformants <em>Informant</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getEntries <em>Entry</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getComponents <em>Component</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getSectionId <em>Section Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SectionImpl#getNullFlavor <em>Null Flavor</em>}</li>
...
public class SectionImpl extends ActImpl implements Section {
	...
	public boolean validateClassCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return SectionOperations.validateClassCode(this, diagnostics, context);
	}
	...
	public boolean validateMoodCode(DiagnosticChain diagnostics, Map<Object, Object> context) {
		return SectionOperations.validateMoodCode(this, diagnostics, context);
	}
	 ...
	 * @generated
	 */
	public EList<ClinicalStatement> getEntryTargets(x_ActRelationshipEntry typeCode, Object targetClass) {
		return SectionOperations.getEntryTargets(this, typeCode, targetClass);
	}
	 ...
	 * @generated
	 */
	public EList<ClinicalStatement> getEntryTargets(Object targetClass) {
		return SectionOperations.getEntryTargets(this, targetClass);
	}
