...
public class CDAAdapterFactory extends AdapterFactoryImpl {
	...
	protected CDASwitch<Adapter> modelSwitch = new CDASwitch<Adapter>() {
			...
			@Override
			public Adapter caseIdentityDoc(IdentityDoc object) {
				return createIdentityDocAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.mdht.uml.cda.IdentityDoc <em>Identity Doc</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createIdentityDocAdapter() {
		return null;
	}
