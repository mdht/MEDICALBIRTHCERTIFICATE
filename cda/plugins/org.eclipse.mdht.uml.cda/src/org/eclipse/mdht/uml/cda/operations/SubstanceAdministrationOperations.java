 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.SubstanceAdministration#validateClassCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Class Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstanceAdministrationOperations extends ClinicalStatementOperations {
    ...
    DatatypesUtil.increment(context,"SubstanceAdministrationClassCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_CLASS_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(substanceAdministration)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
