 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.ObservationRange#validateMoodCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Mood Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObservationRangeOperations extends ActOperations {
    ...
    DatatypesUtil.increment(context,"ObservationRangeMoodCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_MOOD_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(observationRange)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
