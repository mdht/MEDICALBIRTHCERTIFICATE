...
import org.eclipse.mdht.uml.cda.operations.SpecimenOperations;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SpecimenImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SpecimenImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SpecimenImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SpecimenImpl#getSpecimenRole <em>Specimen Role</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SpecimenImpl#getNullFlavor <em>Null Flavor</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SpecimenImpl#getTypeCode <em>Type Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecimenImpl extends ParticipationImpl implements Specimen {
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		nullFlavorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.SPECIMEN__NULL_FLAVOR, oldNullFlavor, nullFlavor, !oldNullFlavorESet));
	}
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.SPECIMEN__NULL_FLAVOR, oldNullFlavor, NULL_FLAVOR_EDEFAULT, oldNullFlavorESet));
	}
	...
	public void setTypeCode(ParticipationType newTypeCode) {
		...
		typeCodeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.SPECIMEN__TYPE_CODE, oldTypeCode, typeCode, !oldTypeCodeESet));
	}
	...
	public void unsetTypeCode() {
		...
		typeCodeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.SPECIMEN__TYPE_CODE, oldTypeCode, TYPE_CODE_EDEFAULT, oldTypeCodeESet));
	}
