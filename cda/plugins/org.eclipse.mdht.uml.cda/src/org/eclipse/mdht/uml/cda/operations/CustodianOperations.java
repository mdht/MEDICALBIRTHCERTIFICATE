 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.Custodian#validateTypeCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Type Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustodianOperations extends ParticipationOperations {
	 ...
	 * @ordered
	 */
	protected static final String VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_EXP = "self.isTypeCodeDefined() implies self.typeCode=vocab::ParticipationType::CST";
	 ...
	 * @generated
	 */
	public static boolean validateTypeCode(Custodian custodian, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"CustodianTypeCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(custodian)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
