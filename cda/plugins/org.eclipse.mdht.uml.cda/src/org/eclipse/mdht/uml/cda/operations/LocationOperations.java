 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.Location#validateTypeCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Type Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LocationOperations extends ParticipationOperations {
	 ...
	 * @generated
	 */
	public static boolean validateTypeCode(Location location, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"LocationTypeCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(location)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
