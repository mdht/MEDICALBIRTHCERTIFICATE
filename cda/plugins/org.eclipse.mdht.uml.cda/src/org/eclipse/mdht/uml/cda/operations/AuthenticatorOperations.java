 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.Authenticator#validateTypeCode(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map) <em>Validate Type Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AuthenticatorOperations extends ParticipationOperations {
	 ...
	 * @generated
	 */
	public static boolean validateTypeCode(Authenticator authenticator, DiagnosticChain diagnostics,
    ...
    DatatypesUtil.increment(context,"AuthenticatorTypeCode","null");
		...
		if (!EOCL_ENV.get().createQuery(VALIDATE_TYPE_CODE__DIAGNOSTIC_CHAIN_MAP__EOCL_INV.get()).check(authenticator)) {
			if (diagnostics != null) {
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
