 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getRealmCodes <em>Realm Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getTypeId <em>Type Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getTemplateIds <em>Template Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getIds <em>Id</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getText <em>Text</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getStatusCode <em>Status Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getEffectiveTimes <em>Effective Time</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getPriorityCode <em>Priority Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getRepeatNumber <em>Repeat Number</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getRouteCode <em>Route Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getApproachSiteCodes <em>Approach Site Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getDoseQuantity <em>Dose Quantity</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getRateQuantity <em>Rate Quantity</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getMaxDoseQuantity <em>Max Dose Quantity</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getAdministrationUnitCode <em>Administration Unit Code</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getSubject <em>Subject</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getSpecimens <em>Specimen</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getConsumable <em>Consumable</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getPerformers <em>Performer</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getAuthors <em>Author</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getInformants <em>Informant</em>}</li>
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getParticipants <em>Participant</em>}</li>
 ...
 *   <li>{@link org.eclipse.mdht.uml.cda.impl.SubstanceAdministrationImpl#getNegationInd <em>Negation Ind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubstanceAdministrationImpl extends ClinicalStatementImpl implements SubstanceAdministration {
	...
	public EList<InFulfillmentOf1> getInFulfillmentOf1s() {
		if (inFulfillmentOf1s == null) {
			inFulfillmentOf1s = new EObjectContainmentEList<InFulfillmentOf1>(InFulfillmentOf1.class, this, CDAPackage.SUBSTANCE_ADMINISTRATION__IN_FULFILLMENT_OF1);
		}
	...
	public void setNullFlavor(NullFlavor newNullFlavor) {
		...
		nullFlavorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.SUBSTANCE_ADMINISTRATION__NULL_FLAVOR, oldNullFlavor, nullFlavor, !oldNullFlavorESet));
	}
	...
	public void unsetNullFlavor() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.SUBSTANCE_ADMINISTRATION__NULL_FLAVOR, oldNullFlavor, NULL_FLAVOR_EDEFAULT, oldNullFlavorESet));
	}
	...
	public void setClassCode(ActClass newClassCode) {
		...
		classCodeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.SUBSTANCE_ADMINISTRATION__CLASS_CODE, oldClassCode, classCode, !oldClassCodeESet));
	}
	...
	public void unsetClassCode() {
		...
		classCodeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.SUBSTANCE_ADMINISTRATION__CLASS_CODE, oldClassCode, CLASS_CODE_EDEFAULT, oldClassCodeESet));
	}
	...
	public void setMoodCode(x_DocumentSubstanceMood newMoodCode) {
		...
		moodCodeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CDAPackage.SUBSTANCE_ADMINISTRATION__MOOD_CODE, oldMoodCode, moodCode, !oldMoodCodeESet));
	}
	...
	public void unsetMoodCode() {
		...
		moodCodeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CDAPackage.SUBSTANCE_ADMINISTRATION__MOOD_CODE, oldMoodCode, MOOD_CODE_EDEFAULT, oldMoodCodeESet));
	}
